...
The public API lives at the module root (`github.com/go-ruby-bcrypt/bcrypt`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `bcrypt`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-bcrypt/bcrypt](https://pkg.go.dev/github.com/go-ruby-bcrypt/bcrypt)**

The module's [README](https://github.com/go-ruby-bcrypt/bcrypt#readme) carries worked
